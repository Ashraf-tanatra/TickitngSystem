namespace ApplicationServices.Constants
{
    public static class Constants
    {
        ...
        public static class Account
        {
            ...
            public const string AccountAlreadyActive =
                "Account is already active.";

            public const string AccountAlreadyDeleted =
                "Account is already deleted.";

            public const string AccountDeletionDateMissing =
                "Account deletion date is missing.";

            public const string ReactivationPeriodExpired =
                "The reactivation period has expired.";

            public const string CannotUpdateDeletedAccount =
                "Cannot update a deleted account.";

            public const string EmailAlreadyExists =
                "An account with this email already exists.";

            public const string CurrentPasswordRequired =
        ...
        public static class Employee
        {
            ...
            public const string CannotUpdateDeletedEmployee =
                "Cannot update a deleted employee.";

            public const string EmployeeAlreadyActive =
                "Employee is already active.";

            public const string EmployeeDeletionDateMissing =
                "Deleted date is not available.";

            public const string EmployeeReactivationPeriodExpired =
        ...
        public static class Project
        {
            ...
            public const string ProjectNameRequired =
                "Project name is required.";

            public const string ProjectDescriptionRequired =
                "Project description is required.";

            public const string EmployeeNotFound =
                "Employee not found.";

            public const string EmployeeAlreadyAssigned =
                "Employee is already assigned to this project.";

            public const string EmployeeNotAssigned =
                "Employee is not assigned to this project.";

            public const string ProjectAlreadyExists =
                "Project already exists.";

            public const string CannotUpdateDeletedProject =
        ...
        public static class Ticket
        {
            ...
            public const string TicketTitleRequired =
            ...
            public const string NoTicketsForProject =
                "There is no ticket available for the specified project.";

            public const string NoTicketsForEmployee =
                "There is no ticket available for the specified employee.";

            public const string UnauthorizedTicketCreation =
                "Only the project manager can create tickets.";

            public const string InvalidPriority =
                "Priority must be between 1 and 3.";

            public const string EmployeeNotAssignedToProject =
